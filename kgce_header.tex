...
{\huge \bfseries \ttitle{Crime rate prediction using K-means}}\\[0.10cm] % Thesis title
...
\textbf{Roll No.50}\\[0.05cm]
\textbf{Hritik Shiraskar}\\[0.01cm]
\textbf{Roll No.44}\\[0.05cm]
\textbf{Ansh Sonawadekar}\\[0.01cm]
\textbf{Roll No.46}\\[0.05cm]
\textit{Guide}\\[0.01cm] 
\textbf{Prof. A.R.Deshmukh}\\[0.35cm]
\begin{figure}[hb!]
 \centering
...
\textsc{DEPARTMENT OF ARTIFICIAL INTELLIGENCE AND DATA SCIENCE \\[0.01cm]
...
\begin{minipage}{0.5\textwidth}
	...
	\end{center}}
\end{minipage}
 %\raisebox{-3.8\height}[0pt][0pt]{\includegraphics[width=\textwidth]{Pictures/KGCE_Letter_head_footer.png}} 
}
%----------------------------------------------------------------------------------------
%	DECLARATION PAGE
%	Your institution may give you a different text to place here
...
%\raisebox{-3.5\height}[0pt][0pt]{\includegraphics[width=\textwidth]{Pictures/KGCE_Letter_head_footer.png}}
}
...
\end{minipage} \\[1cm]
  \large\textbf{Date: \\ Place:}
  %\raisebox{-2.3\height}[0pt][0pt]{\includegraphics[width=\textwidth]{Pictures/KGCE_Letter_head_footer.png}} 
}
...
\fancyhead[L]{\raisebox{-1.0\height}[0pt][0pt]{\includegraphics[scale=0.15]{Pictures/KGCE_Letter_head_header.png}}}
